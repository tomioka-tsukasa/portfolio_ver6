    ...
    <div className={styles.root}>
      <div className={styles.content}>
        <div className={styles.textContainer}>
          ...
          <p className={styles.text}>
            けっこう昔からモノづくりが大好きで、子供の頃から何かを作っては壊し、また作り直すということを繰り返してきました。今でもその情熱は変わらず、新しい技術や表現手法を見つけると「これでどんな面白いことができるだろう？」とワクワクして、気がつくと夜遅くまで実験していることも。技術の向上やクリエイティブな挑戦は、僕にとって趣味と仕事の境界がないくらい純粋に楽しいものです。
          </p>
          <p className={styles.text}>
            仕事中は集中しすぎて口数が少なくなってしまうことがありますが、チームメンバーとのコミュニケーションは大切にしていて、実は人と話すのがとても好きな性格。
          </p>
          <p className={styles.text}>
